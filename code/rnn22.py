...
if __name__ == "__main__":
	...
	if mode == "part-of-speech":
        ...
        you can find 'tag_train.txt' in data_folder after finishing running code
        '''
		data_folder = sys.argv[2]
		...
		tag_train.to_csv(data_folder + '/' + generated_file, sep='\t', index=False)
